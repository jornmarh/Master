...
\chapter{The results of eqvimolar \ch{(CrFeMnNi)Si2} in the $\beta-$\ch{FeSi2} structure}
\label{sec:equi}
...
\end{tabular}
\caption{Band gap in spin up and spin down of SQS D showing the impact of defect states for different occupancy cutoffs  $occ$ on the band gap}
\end{table}
