...
From table 7.3 we see that the defect states are only present in the spin down channel, as the spin up band gap remain constant. We also find that the defect states are located at the band edges, as we can increase the width of the band gap by "removing" more defect states. 
