...
\begin{figure}[H]
	...
	\caption{Probability distribution function \ch{Co4Fe4Mn4Ni4Si32} (SQS (D))}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{results/fesi2/composistions/crfeconi_PDF.png}
	\caption{Probability distribution function \ch{Cr4Fe4Co4Ni4Si32} (SQS (B))}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{results/fesi2/composistions/crfemnco_PDF.png}
	\caption{Probability distribution function \ch{Cr4Fe4Mn4Co4Si32} (SQS (B))}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{results/fesi2/composistions/crfemnti_PDF.png}
	\caption{Probability distribution function \ch{Cr4Fe4Mn4Ti4Si32} (SQS (B))}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{results/fesi2/composistions/crfetini_PDF.png}
	\caption{Probability distribution function \ch{Cr4Fe4Ti4Ni4Si32} (SQS (B))}
\end{figure}
...
\textbf{PDOSs}
\begin{figure}
\includegraphics[width=\textwidth]{results/fesi2/composistions/PDOSs.jpg}
