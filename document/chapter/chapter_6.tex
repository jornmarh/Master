...
6                                                            & -6.586                                                       \\ \bottomrule
\end{tabular}
\caption{Convergence with respect to the total energy of the cutoff energy and density of k-points. The test was conducted for a 48-atom supercell of \ch{Cr4Fe4Mn4Ni4Si32}.}
\end{table}
