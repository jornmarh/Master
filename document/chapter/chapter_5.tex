...
On the other hand, the generalized gradient approximation (GGA) account for the non-homogeneity in the electron density of real materials by including the gradient to calculate $V_{xc}$. 
\begin{equation}
